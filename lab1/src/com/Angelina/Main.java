...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        arrBalls[0] = new BallObj(4.1,"blue");
        arrBalls[1] = new BallObj(5.7,"blue");
        arrBalls[2] = new BallObj(2,"red");
        ...
        Book myBook = new Book("My life", "Angel",20,0);
        ...
        myLibruary.add(new Book("Robinson Crusoe", "Daniel Defoe",22,2));
        myLibruary.add(new Book("Clarissa", "Samuel Richardson",44,3));
        myLibruary.add(new Book("Emma", "Jane Austen",33,1));
        ...
        myLibruary2.add(new Book("Robinson Crusoe", "Daniel Defoe",22,2));
        myLibruary2.add(new Book("Clarissa", "Samuel Richardson",44,3));
        myLibruary2.add(new Book("Emma", "Jane Austen",33,1));
        ...
        myLibruary3.add(new Book("Robinson Crusoe", "Daniel Defoe",22,2));
        myLibruary3.add(new Book("Clarissa", "Samuel Richardson",44,3));
        myLibruary3.add(new Book("Emma", "Jane Austen",33,1));
        ...
        myLibruary4.add(new Book("Robinson Crusoe", "Daniel Defoe",22,2));
        myLibruary4.add(new Book("Clarissa", "Samuel Richardson",44,3));
        myLibruary4.add(new Book("Emma", "Jane Austen",33,1));
